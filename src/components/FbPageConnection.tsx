  ...
  const { data: pages, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const { data, error } = await supabase
        .from("fb_pages")
        .select("id, user_id, fb_page_id, page_name, page_picture_url, page_category, is_active, subscription_status, subscription_error, ig_business_account_id, ig_username, ig_picture_url, ig_subscription_status, subscribed_fields, connected_at, last_sync_at, disconnected_at, pending_delete_at, created_at")
